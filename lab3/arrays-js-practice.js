...
let courses = [
    ...
    [2, 'Цікава Хімія: Шипучки та Вулкани', 'Наука Дітям', ['Анна Cидоренко', 'Максим Вовк'], 'Практичні', 650, 1000, 720],
    ...
    [8, 'Навколо Світу: Географія для малят', 'Юні Дослідники', ['Марина Ткач'], 'Тести', 400, 310, 630],
